...
export function StartupOverlay() {
  ...
  return (
    <div
      className={`bg-background fixed inset-0 z-[100] flex items-center justify-center transition-opacity duration-700 ${
          ...
          {services.map((svc) => (
            ...
            >
              ...
              <div className="flex-shrink-0 text-xs">
                {svc.state === "ready" ? (
                  <span className="font-medium text-green-500">就绪</span>
                ) : (
